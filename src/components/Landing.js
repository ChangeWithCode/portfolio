...
const Landing = () => {
    ...
    <><div class="px-1 py-2 my-5 col-xxl-12 text-center">
            ...
            <h1 class="display-5 fw-bold f-l landing_heading">Hi, I'm Muhammad Qasim AKA Mystery</h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead  p-4 fs-1 landing_para">“If you think math is hard, try web design.”</p>
